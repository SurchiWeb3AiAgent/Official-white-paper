...
The $SURCHI ecosystem is built on the Solana blockchain with a **Zero-Team-Allocation** model, ensuring that 100% of the value remains within the community.




## 📋 Token Overview
- **Name:** SURCHI (Neural Sentinel)
- **Ticker:** $SURCHI
- **Network:** Solana (SPL)
- **Total Supply:** 19,897,905 $SURCHI
...
By allocating **70% to the Public Presale** with an immediate unlock, we ensure that the community holds the majority of the power from Day 1. There are no "hidden" seed rounds or venture capital locks that could dump on retail holders later.

### 2. Verified Liquidity Locking
To prevent price manipulation and provide trading confidence, **25% of the total supply** is paired and locked via **Squads Multisig**. 
* **Lock Duration:** 24 Months.
* **Purpose:** Ensures deep liquidity and long-term price stability.

### 3. Community Reserve & Growth
The remaining **5%** is held in a community-governed treasury. These funds are specifically reserved for:
* **Staking Rewards:** Incentivizing long-term holders.
* **DAO Grants:** Funding community-led development of the Neural Sentinel AI agents.
* **Strategic Partnerships:** Expanding the $SURCHI footprint in the DeFi space.

### 4. Zero Team/Advisor Bags
$SURCHI is a purely community-driven project. There is **0% allocation** for founders, team members, or advisors. The team participates in the ecosystem on the same terms as every other community member.
____
...
---
*Generated by the Surchi Foundation. Decentralized. Secure. Autonomous.*
